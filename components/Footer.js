	...
	return (
		<div className={styles.background}>
			<div className={styles.main}>
				<div className={styles.flex}>
					...
					<div className={styles.icons}>
						...
						<i className='devicon-coffeescript-original'></i>
					</div>
				</div>
				<div className={styles.flex}>
					<div>Categories</div>
			...
			<div className={styles.last}>
				<small >
					Created with <span className='material-icons'>favorite_border</span> By
					Srijeet Tamrakar-2021
				</small>
				<div>
					VISA&nbsp;<i className='devicon-vuejs-plain'></i>
				</div>
			</div>
		</div>
	);
